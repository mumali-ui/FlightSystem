sap.ui.define([
	...
	return BaseObject.extend("flightsystem.model.GroupSortState", {
		 ...
		 * @alias flightsystem.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "FR_CITY");
			}
