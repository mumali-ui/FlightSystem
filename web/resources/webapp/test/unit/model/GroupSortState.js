sap.ui.define([
		"flightsystem/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("FR_CITY").length, 1, "The sorting by FR_CITY returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by FR_CITY and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("FR_CITY");
