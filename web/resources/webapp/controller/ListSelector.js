sap.ui.define([
		...
		return BaseObject.extend("flightsystem.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias flightsystem.model.ListSelector
			 */
			 ...
			 * @return {flightsystem.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
